...
export const studentUpdateProfileDetails =
  (history, fields) => async (dispatch) => {
    try {
...
export const studentUpdateProfilePicture =
  (history, image) => async (dispatch) => {
    try {
...
export const studentAddSemesterDetails =
  (history, fields, setIsLoading) => async (dispatch) => {
    try {
...
export const studentUpdateSemesterDetails =
  (history, fields) => async (dispatch) => {
    try {
      console.log("in actions for semdetails", fields);
...
export const studentDeleteSemesterDetails =
  (history, fields) => async (dispatch) => {
    try {
      console.log("in actions for semdetails", fields);
...
export const studentUpdatePastEduDetails =
  (history, fields) => async (dispatch) => {
    try {
...
export const studentGetAllStudentsOfMentor =
  (history, setMyMentees) => async (dispatch) => {
    try {
